...
def detect_object(yolo, image, save_img, save_img_path="./", postfix=""): #img_path --> image
    """
    ...
    """
    # modified this part of the code to receive image directly from object detection ROS node instead of path to the image file
    '''try:
